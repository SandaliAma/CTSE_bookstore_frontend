    ...
    <div style={s.page}>
      ...
      <div style={s.leftPanel}>
        <div style={s.leftContent}>
          ...
          <h2 style={s.heroTitle}>Join thousands of<br />book lovers today.</h2>
          <p style={s.heroSub}>Create your free account and get access to our complete catalog, order tracking, and personalized notifications.</p>
          <div style={s.perks}>
            {[
        ...
        <div style={s.card}>
          {success ? (
            <div style={s.successBox}>
              ...
              <p style={s.successSub}>Welcome to BookStore, {form.username}!<br />Redirecting you to sign in...</p>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={s.form}>
                <Field label="Username" name="username" value={form.username} onChange={handleChange} placeholder="e.g. john_doe" required />
                ...
                <Field label="Password" name="password" type="password" value={form.password} onChange={handleChange} placeholder="Min. 6 characters" required minLength={6} />
...
const s: Record<string, React.CSSProperties> = {
  ...
  logoText: { fontSize: 26, fontWeight: 800, color: colors.accent, fontFamily: font.sans },
  heroTitle: { fontSize: 34, fontWeight: 800, color: "#f8fafc", lineHeight: 1.25, margin: "0 0 14px" },
  heroSub: { fontSize: 15, color: "#94a3b8", lineHeight: 1.7, margin: "0 0 32px" },
  ...
  rightPanel: {
    width: 480, background: "#f9fafb",
    display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 32px",
  },
  card: {
    width: "100%", maxWidth: 400, background: "#fff",
    borderRadius: 16, padding: "36px 32px",
    boxShadow: "0 4px 24px rgba(0,0,0,0.10)", border: "1px solid #e5e7eb",
  },
  cardTitle: { fontSize: 24, fontWeight: 700, color: "#111827", margin: "0 0 6px" },
  ...
  submitBtn: {
    ...
    cursor: "pointer", fontFamily: font.sans, marginTop: 4,
  },
  loginText: { textAlign: "center", fontSize: 14, color: "#6b7280", marginTop: 18 },
  link: { color: colors.accent, fontWeight: 600, textDecoration: "none" },
  successBox: { textAlign: "center", padding: "20px 0" },
  successIcon: { fontSize: 56, marginBottom: 12 },
  successTitle: { fontSize: 22, fontWeight: 800, color: "#111827", margin: "0 0 8px" },
  successSub: { fontSize: 14, color: "#6b7280", lineHeight: 1.6, margin: "0 0 24px" },
  successBar: { height: 4, background: "#e5e7eb", borderRadius: 4, overflow: "hidden" },
  successBarFill: {
